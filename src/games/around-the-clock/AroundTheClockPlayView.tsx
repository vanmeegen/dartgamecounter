/**
 * AroundTheClockPlayView - complete gameplay view for Around the Clock
 */
...
import { AroundTheClockScoreDisplay } from "./AroundTheClockScoreDisplay";
import type { GamePlayComponentProps } from "../types";
import type { AroundTheClockGame } from "./AroundTheClockGame";

export const AroundTheClockPlayView = observer(function AroundTheClockPlayView({
  game: baseGame,
  onThrow,
  onUndo,
  onLegFinished,
  ...
  const game = baseGame as AroundTheClockGame;
  ...
  return (
    ...
    >
      <Box sx={{ flexShrink: 0, position: "relative" }}>
        ...
        <AroundTheClockScoreDisplay game={game} />
      </Box>
