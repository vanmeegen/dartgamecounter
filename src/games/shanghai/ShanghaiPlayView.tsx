/**
 * ShanghaiPlayView - complete gameplay view for Shanghai
 */
...
import { ShanghaiScoreDisplay } from "./ShanghaiScoreDisplay";
import type { GamePlayComponentProps } from "../types";
import type { ShanghaiGame } from "./ShanghaiGame";

export const ShanghaiPlayView = observer(function ShanghaiPlayView({
  game: baseGame,
  onThrow,
  onUndo,
  onLegFinished,
  ...
  const game = baseGame as ShanghaiGame;
  ...
  return (
    ...
    >
      <Box sx={{ flexShrink: 0, position: "relative" }}>
        ...
        <ShanghaiScoreDisplay game={game} />
      </Box>
