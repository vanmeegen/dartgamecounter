/**
 * HalveItPlayView - complete gameplay view for Halve It
 */
...
import { HalveItScoreDisplay } from "./HalveItScoreDisplay";
import type { GamePlayComponentProps } from "../types";
import type { HalveItGame } from "./HalveItGame";

export const HalveItPlayView = observer(function HalveItPlayView({
  game: baseGame,
  onThrow,
  onUndo,
  onLegFinished,
  ...
  const game = baseGame as HalveItGame;
