/**
 * CricketPlayView - complete gameplay view for Cricket
 */
...
import { CricketScoreDisplay } from "./CricketScoreDisplay";
import type { GamePlayComponentProps } from "../types";
import type { CricketGame } from "./CricketGame";

export const CricketPlayView = observer(function CricketPlayView({
  game: baseGame,
  onThrow,
  onUndo,
  onLegFinished,
  ...
  const game = baseGame as CricketGame;
  ...
  const legWinner = game.isLegFinished() || game.isFinished() ? game.getWinner() : null;
